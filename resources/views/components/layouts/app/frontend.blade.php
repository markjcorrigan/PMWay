            ...
            <div class="relative">
                <flux:dropdown>
                    ...
                    <flux:menu class="!bg-gray-900">
                        @guest
                            <flux:navbar.item class="text-white" style="color: white !important" href="{{ route('portfolio') }}" :current="request()->routeIs('portfolio')"> Portfolio </flux:navbar.item>
                            ...
                            <flux:navbar.item class="text-white" style="color: white !important" href="{{ route('contact') }}" :current="request()->routeIs('contact')"> Contact </flux:navbar.item>
                        @endguest
                        @auth
...
{{--    <flux:main;--}}
{{--    <flux:main container style="padding-bottom: 50px; padding-top: 60px; flex-grow: 1;">--}}
{{--        <div>--}}
{{--            {{ $slot }}--}}
{{--        </div>--}}
{{--    </flux:main>--}}
