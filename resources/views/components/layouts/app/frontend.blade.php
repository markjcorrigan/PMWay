...
<flux:header class="w-full flex justify-between px-6 sm:pr-8 md:pr-12 py-2 bg-gray-900 shadow-md">
...
@if (Route::has('login'))
        ...
        <nav class="flex items-center justify-end gap-4">
            @guest
                ...
                <flux:button href="{{ route('login') }}" variant="primary" class="custom-button hover:text-white">
                    {{ __('global.log_in') }}
                </flux:button>


            @if (Route::has('register'))
                    <flux:button href="{{ route('register') }}" variant="primary"  class="custom-button hover:text-white"
                    >
                        {{ __('global.register') }}
                    </flux:button>
                @endif
