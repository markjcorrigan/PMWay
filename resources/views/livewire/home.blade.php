...
{{--        </h1>--}}
        ...
        <!--BODY-->
            ...
            <br>
    <button x-on:click="if (@this.showCollapse) { @this.set('showCollapse', false); window.location.reload(); } else { @this.set('showCollapse', true); }" class="bg-gray-900 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">

    {{--    <button wire:click="toggleCollapse" class="bg-gray-900 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">--}}
        Click here for an explanation
    </button>

    <div class="{{ $showCollapse ? '' : 'hidden' }}">
                        ...
                        <div class="card text-center">
                            ...
                            <div class="card-body text-left">
                                ...
                                <p>For Systems Engineering the CMMi Dashboard for
                                    ...
                                    [<a href="/?slide=14" target="_blank">CMM People</a>, <a href="/cmmidevdash" target="_blank">CMMi for Development</a>, CMMi for Services &amp; CMMi for
...
{{--                <button id="refresh-button" class="bg-gray-100 hover:bg-gray-300 text-gray-500 text-xs py-1 px-2 rounded" title="On landing here if About menu is stuck click here to wake it up">Wake up About</button>--}}
{{--            </div>--}}
{{--            <h5>Based on recent project performance, where would you pin down your Capability Maturity level?</h5>--}}
            <br>
            <div align="center"><img class="img-fluid" src="/images/dunningkrugereffectonprojectprocesseswithnopin200.png"> </div>
